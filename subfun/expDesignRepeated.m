...
function [cfg] = expDesignRepeated(cfg, displayFigs)
    ...
    while 1
        ...
        soundTargets = zeros(NB_BLOCKS, NB_EVENTS_PER_BLOCK/2);%24
        ...
        for iBlock = 1:NB_BLOCKS
            ...
            % Fixation targets
            forbiddenPositions=[1 NB_EVENTS_PER_BLOCK/2];
...
%             % Sound targets
%             forbiddenPositions = [1,NB_EVENTS_PER_BLOCK/2,chosenPosition];
%             chosenPosition = setTargetPositionInSequence( ...
%                                                          NB_EVENTS_PER_BLOCK/2, ...
%                                                          nbTarget, ...
%                                                          forbiddenPositions);
