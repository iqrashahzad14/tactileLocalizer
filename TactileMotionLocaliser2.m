%% Tactile (Auditory) hMT localizer using translational motion in four directions
...
%%
%%static directions are [-1,-2,-1,-2] with targets being -1,-1 (i.e. only
%%the first stimulus repeated
%%motion blocks are [right left up down] with targets being right right or
%%up up
%%task is to detect the repeated stimulus / ISI = 0.5s
%%
